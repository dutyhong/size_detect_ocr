...
SECRET_KEY = '3+wm#%35fe#$ny=ti7^h+gv*(q@_d!6oo%uub8n!xiz28=mr@t'
...
KAFKA_NODE = 'gz-kafka-dev.duolainc.com:9092'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'demo': {  # 专门定义一个收集特定信息的日志
            ...
            'filename': os.path.join(str(BASE_DIR) + '/logs/', "demo.log"),
        ...
        'city': {  # 专门定义一个收集特定信息的日志
            'level': 'INFO',
            'class': 'logging.handlers.RotatingFileHandler',  # 保存到文件，自动切
            'filename': os.path.join(str(BASE_DIR) + '/logs/', "city.log"),
            'maxBytes': 1024 * 1024 * 50,  # 日志大小 50M
            'backupCount': 5,
            'formatter': 'verbose',
            'encoding': "utf-8"
