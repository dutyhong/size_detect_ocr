...
from sizechart_detect.global_config import CRNN_MODELS_DIR
from sizechart_detect.recognize.crnn import CRNN
from sizechart_detect.recognize import config
...
# recognize api
class PytorchOcr():
    def __init__(self, model_path=CRNN_MODELS_DIR+'CRNN-1010.pth'):
